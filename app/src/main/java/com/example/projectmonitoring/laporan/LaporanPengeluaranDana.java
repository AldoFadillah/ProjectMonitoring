...
public class LaporanPengeluaranDana extends AppCompatActivity implements ListView.OnItemClickListener, SwipeRefreshLayout.OnRefreshListener{
    private static final String TAG = LaporanPengeluaranDana.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_laporan_pengeluaran_dana);

        requestQueue = Volley.newRequestQueue(LaporanPengeluaranDana.this);

        listProyek = (ListView) findViewById(R.id.listProyek);
        ...
        adapter = new Adapter(LaporanPengeluaranDana.this, listData);
        listProyek.setAdapter(adapter);
        ...
        editTextTanggalMulai.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                new DatePickerDialog(LaporanPengeluaranDana.this, date1, myCalendar1
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                if(s.toString().trim().length()==0){
                    editTextTanggalSelesai.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            new AlertDialog.Builder(LaporanPengeluaranDana.this)
                    ...
                    editTextTanggalSelesai.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            // TODO Auto-generated method stub
                            new DatePickerDialog(LaporanPengeluaranDana.this, date2, myCalendar2
    ...
    private void cariData() {
        pDialog = new ProgressDialog(LaporanPengeluaranDana.this);
        ...
        listProyek.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position,
                                    long id) {
                Intent intent = new Intent(LaporanPengeluaranDana.this, LaporanDetailCetakPengeluaranDana.class);
