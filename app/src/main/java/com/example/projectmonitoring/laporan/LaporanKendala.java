...
public class LaporanKendala extends AppCompatActivity implements ListView.OnItemClickListener, SwipeRefreshLayout.OnRefreshListener{
    private static final String TAG = LaporanKendala.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_laporan_kendala);

        requestQueue = Volley.newRequestQueue(LaporanKendala.this);
        ...
        adapter = new Adapter(LaporanKendala.this, listData);
        ...
        editTextTanggalMulai.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                new DatePickerDialog(LaporanKendala.this, date1, myCalendar1
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                if(s.toString().trim().length()==0){
                    editTextTanggalSelesai.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            new AlertDialog.Builder(LaporanKendala.this)
                    ...
                    editTextTanggalSelesai.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            // TODO Auto-generated method stub
                            new DatePickerDialog(LaporanKendala.this, date2, myCalendar2
    ...
    private void cariData() {
        pDialog = new ProgressDialog(LaporanKendala.this);
        pDialog.setCancelable(true);
        pDialog.setMessage("Loading...");
        pDialog.show();

        StringRequest strReq = new StringRequest(Request.Method.POST, ServerKendala.URL_SEARCH_KENDALA, new Response.Listener<String>() {
            @Override
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position,
                                    long id) {
                Intent intent = new Intent(LaporanKendala.this, DetailCetakKendala.class);
