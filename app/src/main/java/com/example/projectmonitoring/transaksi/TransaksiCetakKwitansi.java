...
public class TransaksiCetakKwitansi extends AppCompatActivity implements ListView.OnItemClickListener, SwipeRefreshLayout.OnRefreshListener{
    private static final String TAG = TransaksiCetakKwitansi.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_transaksi_cetak_kwitansi);

        requestQueue = Volley.newRequestQueue(TransaksiCetakKwitansi.this);
        ...
        adapter = new Adapter(TransaksiCetakKwitansi.this, listData);
        ...
        editTextTanggalMulai.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                new DatePickerDialog(TransaksiCetakKwitansi.this, date1, myCalendar1
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                if(s.toString().trim().length()==0){
                    editTextTanggalSelesai.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            new AlertDialog.Builder(TransaksiCetakKwitansi.this)
                    ...
                    editTextTanggalSelesai.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            // TODO Auto-generated method stub
                            new DatePickerDialog(TransaksiCetakKwitansi.this, date2, myCalendar2
    ...
    private void cariData() {
        pDialog = new ProgressDialog(TransaksiCetakKwitansi.this);
                ...
                try {
                    ...
                    if (value == 1) {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            data.setNamaClient(json.getString(ServerKwitansi.TAG_NAMA_CLIENT));
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position,
                                    long id) {
                Intent intent = new Intent(TransaksiCetakKwitansi.this, TransaksiDetailCetakKwitansi.class);
                ...
                intent.putExtra(ServerKwitansi.TAG_NAMA_CLIENT,listData.get(position).getNamaClient());
