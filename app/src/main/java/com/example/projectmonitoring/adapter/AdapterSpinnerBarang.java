...
public class AdapterSpinnerBarang extends BaseAdapter {
    private Activity activity;
    private LayoutInflater inflater;
    private List<DataBarang> item;

    public AdapterSpinnerBarang(Activity activity, List<DataBarang> item) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null)
            convertView = inflater.inflate(R.layout.list_barang_spinner, null);
